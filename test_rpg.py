...
def test_curar_personaje():
    heroe = Personaje()
    enemigo = Personaje()
    enemigo.atacar(heroe, dano=200) # HP baja a 800
...
def test_no_curar_mas_del_maximo():
    heroe = Personaje()
    enemigo = Personaje()
    enemigo.atacar(heroe, dano=100) # HP 900
    
    heroe.curar(heroe, cantidad=200)
...
def test_los_muertos_no_se_curan():
    heroe = Personaje()
    enemigo = Personaje()
    enemigo.atacar(heroe, dano=1000) # HP 0, Muerto
